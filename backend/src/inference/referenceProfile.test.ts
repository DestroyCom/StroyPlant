...
function fakePlantProfile(overrides: Partial<PlantProfile> = {}): PlantProfile {
  return {
    ...
    wetCalibrationSampleCount: null,
    irrigateCalibrationSampleCount: null,
    irrigateEcoCalibrationSampleCount: null,
    parrotSpeciesId: null,
    heightMinCm: null,
    heightMaxCm: null,
    spreadMinCm: null,
    spreadMaxCm: null,
    hardinessZoneMinValue: null,
    hardinessZoneMaxValue: null,
    heatZoneMinValue: null,
    heatZoneMaxValue: null,
    tDyingC: null,
    popularity: null,
    genusName: null,
    speciesName: null,
    ...
    isTaxonomyGroupHead: null,
    taxonomyGroupSubelementsCount: null,
    tags: null,
    noFert: null,
    hidden: null,
    synonyms: null,
    nameFirstLetterLatin: null,
    orderIndexForSortingLatin: null,
    sunCategory: null,
    waterCategory: null,
