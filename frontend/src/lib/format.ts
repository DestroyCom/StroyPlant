...
export function molToLuxLabel(mol: number): string {
  // Garde-fou : une entrée non finie (NaN/Infinity) produirait un libellé « NaN klux » affiché tel
  // quel dans la légende de la gauge. Inatteignable aujourd'hui (l'appelant ne passe qu'un nombre
  // réel, sinon il n'affiche pas la ligne), mais l'assurance coûte une ligne.
